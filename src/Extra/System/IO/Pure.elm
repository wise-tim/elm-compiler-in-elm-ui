...
foldlMList callback zero list =
    loop (foldlMHelpList callback) ( MList.reverse list, zero )
...
foldrMList callback zero list =
    loop (foldrMHelpList callback) ( list, zero )
...
forMList_ list callback =
    loop (mapMListHelp_ callback) ( MList.reverse list, pure () )
...
foldlMMap callback zero map =
    loop (foldlMHelpMap callback) ( MList.reverse (Map.toList map), zero )
...
mapMMap_ callback map =
    loop (mapMMapHelp_ callback) ( MList.reverse (Map.toList map), pure () )
